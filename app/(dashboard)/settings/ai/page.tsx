...
export default function AISettingsPage() {
  ...
  useEffect(() => {
    ...
    // For now, just show "configured" if the server env is set correctly.
    ...
    <div className="max-w-2xl mx-auto space-y-8 p-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Configure AI features powered by NVIDIA NIM
        </p>
      </div>
      ...
      <div className="rounded-lg border p-4 bg-muted/30">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-semibold">NVIDIA API Key</p>
            <p className="text-xs text-muted-foreground mt-0.5">
              Set `NVIDIA_API_KEY` in your `.env` file. Restart the app after changes.
            </p>
          </div>
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            ...
            <input
              ...
              className="mt-1 w-full rounded-md border px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary"
            />
            <p className="text-xs text-muted-foreground mt-1">Estimated monthly AI cost cap</p>
          </div>
        </div>
      </section>
